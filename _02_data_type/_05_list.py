...
#- list 저장 요소 추가/삭제/수정
    # - list는 동적으로 크기변경이 가능한 mutable 가료형이다!
...
print("추가전 id : ", id(lst)) # 1796190769472
...
lst.pop(2)
print("lst:",lst)
print('id(lst):',id(lst))# 제거 해도 그대로 유지됨
...
print(len(students[0][0])) #홍길동 글자수


#str.split
# str 구분자를 기준으로 나눠서list 형태로 변환
...
print('fruits.count("banana"):',fruits.count("banana")) #1
print('fruits.count("kiwi"):',fruits.count("kiwi"))# 0
